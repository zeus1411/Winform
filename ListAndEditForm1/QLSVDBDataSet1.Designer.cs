...
namespace ListAndEditForm1 {
    ...
    public partial class QLSVDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(int Id, string fname, string lname) {
...
namespace ListAndEditForm1.QLSVDBDataSet1TableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[std] WHERE (([Id] = @Original_Id) AND ((@IsNull_fname = 1 AND " +
                "[fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [ln" +
                "ame] IS NULL) OR ([lname] = @Original_lname)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[std] ([Id], [fname], [lname]) VALUES (@Id, @fname, @lname);\r\nS" +
                "ELECT Id, fname, lname FROM std WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [Id] = @Id, [fname] = @fname, [lname] = @lname WHERE (([Id] = @Original_Id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)));
