...
namespace ListAndEditForm1.QLSVDBDataSet4TableAdapters {
...
SELECT Id, fname, lname, bdate, email, gender, phone, address, picture FROM std WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_email, string Original_gender, string Original_phone, string Original_address) {
        ...
        public virtual int Update(
                    ...
                    string Original_phone, 
                    string Original_address) {
            return this.Update(Original_Id, fname, lname, bdate, email, gender, phone, address, picture, Original_Id, Original_fname, Original_lname, Original_bdate, Original_email, Original_gender, Original_phone, Original_address);
        }
    }
