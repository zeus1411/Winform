...
SELECT Id, fname, lname, bdate, email, gender, phone, address, SelectedCourse, picture FROM std WHERE (Id = @Id)";
        ...
        public virtual int Update(
                    ...
                    string Original_phone, 
                    string Original_address) {
            return this.Update(Original_Id, fname, lname, bdate, email, gender, phone, address, SelectedCourse, picture, Original_Id, Original_fname, Original_lname, Original_bdate, Original_email, Original_gender, Original_phone, Original_address);
        }
    }
